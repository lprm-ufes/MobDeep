...
def rgan_options_parser():
    ...
    parser.add_argument('--model_params', help='parameters of a trained model',type=str, default='')
    ...
    parser.add_argument('--normalise', type=str2bool, default=False, help='normalise the \
    ...
    parser.add_argument('--one_hot', type=str2bool, default=False, help='convert categorical \
            conditional information to one-hot encoding')
    parser.add_argument('--predict_labels', type=str2bool, default=False, help='instead \
    ...
    parser.add_argument('--full_mnist', type=str2bool, default=False)
            ### for loading
    ...
    parser.add_argument('--batch_mean', type=str2bool, default=False, help='append the mean \
            of the batch to all variables for calculating discriminator loss')
    parser.add_argument('--learn_scale', type=str2bool, default=False, help='make the \
    ...
    parser.add_argument('--use_time', type=str2bool, default=False, help='enforce \
            latent dimension 0 to correspond to time')
    parser.add_argument('--WGAN', type=str2bool, default=False)
    parser.add_argument('--WGAN_clip', type=str2bool, default=False)
    parser.add_argument('--shuffle', type=str2bool, default=True)
    parser.add_argument('--wrong_labels', type=str2bool, default=False, help='augment \
    ...
    parser.add_argument('--dp', type=str2bool, default=False, help='train discriminator \
    ...
    parser.add_argument('--num_generated_features', type=int, default=1,
            help='number of features to be generated')
    parser.add_argument('--datadir',type=str,
            help='path from where to load dataset')
    parser.add_argument('--exp_id',type=str,help='experiment id used in MobDeep framework')
    parser.add_argument('--test_id',type=str,help='current test id. Used in MobDeep framework')
    parser.add_argument('--save_freq',type=int, default=1,help='Frequence to save model')
